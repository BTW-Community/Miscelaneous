...
public class JBItemProjectionLens extends Item{
	...
	public static final String[] iconNames = new String[] {"jbItemLensNormal1", "jbItemLensNormal2", "jbItemLensNormal3", "jbItemLensNether1", "jbItemLensNether2", "jbItemLensNether3"};
	private Icon[] icons;
	...
	public Icon getIconFromDamage(int damage) {
		int var2 = MathHelper.clamp_int(damage, 0, 5);
